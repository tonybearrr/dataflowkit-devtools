...
<svelte:head>
	<title>API Request Builder – Dev Toolbox</title>
	<meta
		name="description"
...
<div class="max-w-7xl mx-auto px-4 py-8">
	<header class="mb-8">
		<h1 class="text-3xl font-bold mb-3">API Request Builder</h1>
		<p class="text-[var(--color-text-muted)] max-w-2xl">
			Build HTTP requests and generate ready-to-use code snippets for curl, fetch, and axios. Great
			for debugging APIs, sharing reproducible requests, and documenting integrations.
		</p>
	</header>
			...
			>
				...
				{#if !url.trim()}
					<div class="py-8 text-center text-[var(--color-text-muted)]">
						<p>Enter a URL to generate code</p>
					</div>
	...
	<section class="mt-16 prose prose-invert max-w-none">
		<h2 class="text-xl font-semibold mb-4">About API Request Builder</h2>
		<p class="text-[var(--color-text-muted)] mb-4">
			This tool helps you build HTTP requests and generate code snippets for different HTTP
			clients. Whether you're debugging an API, documenting integrations, or sharing reproducible
			requests with teammates, this builder saves time.
		</p>

		<h3 class="text-lg font-medium mt-6 mb-3">Supported Output Formats</h3>
		<ul class="text-[var(--color-text-muted)] space-y-2 list-disc list-inside">
			<li>
				<strong>curl</strong> — Universal command-line tool, works everywhere
			</li>
			<li>
				<strong>fetch</strong> — Native browser/Node.js API with TypeScript types
			</li>
			<li>
				<strong>axios</strong> — Popular HTTP client with rich features
			</li>
			<li>
				<strong>httpie</strong> — Developer-friendly CLI with intuitive syntax
			</li>
		</ul>

		<h3 class="text-lg font-medium mt-6 mb-3">Privacy Note</h3>
		<p class="text-[var(--color-text-muted)]">
			This tool runs entirely in your browser. No requests are sent, no data is stored on any
			server. Your API keys and tokens stay private.
		</p>
	</section>
</div>
