...
<div class="max-w-2xl mx-auto px-4 py-16">
	...
	<div class="space-y-4 text-[var(--color-text-muted)]">
		<p>
			I'm <strong class="text-[var(--color-text)]">Anton Bulavenko</strong>, a frontend engineer
			building fast, privacy-first tools for developers.
		</p>

		<p>I care about performance, user experience, and practical software that respects users.</p>

		<p>
			Dev Toolbox is built with this philosophy: useful tools that work locally, don't track you,
